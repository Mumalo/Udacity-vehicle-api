...
public class CarControllerTest {
    ...
    private void createCar(Long id){
        System.err.println("creating car" + id);
        Car car = getCar();
        car.setId(id);
    ...
    public void findCar() throws Exception {
        ...
        mvc.perform(get(new URI("/cars/1")))
                ...
                .andExpect(jsonPath("$.createdAt", equalTo(car.getCreatedAt())))
                .andExpect(jsonPath("$.modifiedAt", equalTo(car.getModifiedAt())))
